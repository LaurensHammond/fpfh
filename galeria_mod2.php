...
?>	
<h2>Usuwanie albumu</h2>
<form action="galeria_album_usun.php" method="post">
Nazwa albumu:<br/>
<select name="album">
<?php
...
Data dodania albumu:<br/>
<input type="date" name="dzien"></input><br/>
<input type="submit" value="USUŃ ALBUM"></input>
</form>	
	</div>
	<div style="clear:both;"></div>
</div>
