...
{
echo "<a href='galeria_mod1.php'>[------- + DODAJ ALBUM -----]</a>";
echo "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='galeria_mod2.php'>[------- - USUŃ ALBUM -------]</a><br/><br/>";	
echo "<a href='galeria_album.php'>[------ + dodaj zdjęcie ----]</a>";
}
	...
	{
		$sql = "SELECT * FROM galeria ORDER BY Data DESC";
		if($rezultat = @$polaczenie->query($sql))
		{
			$ile_postow = $rezultat->num_rows;
			for($i=0;$i<$ile_postow;$i++)
			{	
				$sql2 = "SELECT * FROM galeria ORDER BY Data DESC LIMIT 1 OFFSET $i";
					...
					{
					echo "<div class='zdj'>";
					$sciezka='Galeria/'.$album.'/'.$album.$j.'.jpeg';
					echo '<a href='.$sciezka.' target=_blank><img src='.$sciezka.' width=100%  /></a>';
					echo '</div>';
					}
