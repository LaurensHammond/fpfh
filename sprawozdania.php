...
<div class="container">
	...
	<div id="main">
	<h1><center>Sprawozdania</center></h1>
<?php
	
if(isset($_SESSION['admin'])&&($_SESSION['admin']==true))
{
echo "<a href='sprawozdania_mod1.php'>[------ + DODAJ SPRAWOZDANIE -----]</a>";
echo "<a href='sprawozdania_mod2.php'>[------ - USUŃ SPRAWOZDANIE -------]</a><br/>";	
}
	...
	{
		$sql = "SELECT * FROM sprawozdania ORDER BY Rok";
		if($rezultat = $polaczenie->query($sql))
		{
			$ile_postow = $rezultat->num_rows;
			for($i=0;$i<$ile_postow;$i++)
			{	
				$sql2 = "SELECT * FROM sprawozdania ORDER BY Rok LIMIT 1 OFFSET $i";
					...
					{
						echo "<h2>$rok</h2>";
						echo "<a href='sprawozdania/$link'>Sprawozdanie z roku $rok w formacie .pdf</a><br/><br/>";
					}
					if($opis!='')
					echo "<span style='margin:15px;'>$opis </span><br/><br/>";
					echo '</div>';
			}
		}
		else
