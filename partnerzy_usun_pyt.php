...
<?php
	echo '<h2><center>Panel Administratora - Partnerzy!</center></h2>';
...
<?php
	...
	{
		echo "<span style='color:red;'>Błąd połączenia z bazą... Spróbuj ponowanie1!</span>";
	}
	else	
	{	
		echo "Nazwa: $tytul2 <br/>";
		$sql = "SELECT * FROM partnerzy WHERE Nazwa ='$tytul2'";
		if($rezultat = @$polaczenie->query($sql))
		{
			...
			if($ile_postow!=0)
			{
				echo	"Czy na pewno chcesz usunąć tego partnera? <br/>";
				echo "<form action='partnerzy_usun.php' method='post'>";
				echo "<input type='hidden' name='nazwa' value='$tytul2'/>";
			...
			{	echo "<span style='color:red;'>Taki Partner nie istnieje!</span>";
			}
		}
		else
		{   echo "<span style='color:red;'>Błąd połączenia z bazą... Spróbuj ponowanie2!</span>";
		}
