...
<?php
	echo '<h2><center>Panel Administratora - Galeria!</center></h2>';
...
?>	
<h2>Dodawanie albumu</h2>
<form action="galeria_album_dodaj.php" method="post">
Nazwa albumu:<br/>
<input type="text" name="album" size="30"></input><br/>
<input type="submit" value="DODAJ ALBUM"></input>
</form>	
<a href='galeria_album'><br><br>[---Dodaj zdjęcie do istniejącego albumu---]</a>
	</div>
	<div style="clear:both;"></div>
</div>
<div style="clear:both;"></div>
