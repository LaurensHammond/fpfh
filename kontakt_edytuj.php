...
<?php
echo '<table><tr ><td valign="top" style="text-align:right; border-right: 1px dashed #333333; padding-right:30px;">';
...
require_once"baza.php";
	...
	{
		echo "Połącznie z bazą nie może być zrealizowane2";
	}
	else	
	{
		$sql = "SELECT * FROM Kontakt WHERE Kat='$kat' AND Naglowek='$naglowek'";
		...
		{	
					...
					$waga = $wiersz['Waga'];
					$id = $wiersz['Id'];
					echo "<font color='#333333'> Aktualne:</font><br/>";
					echo "<br/>$naglowek <br/><br/>";
					echo ">>>>>><br/>>>>>>><br/>>>>>>><br/> <br/>";
					echo "$waga <br/><br/>";
					echo "$kat <br/>";
		...
		{   echo "Połącznie z bazą nie może być zrealizowane1";
		}
...
<font color="#333333">Zmienione:</font><br/>
<form action="kontakt_edytuj1.php" method="post">
<input type="hidden" name="id" value="$id"/>
<u>Nagłówek:</u><br/>
<input type="text" name="naglowek2" size="28"></input><br/>
<u>Wartość:</u><br/>
<textarea cols="30" rows="4" name="dane2">$dane</textarea><br/>
<u>Waga:</u><br/>
<input type="text" name="waga2" size="1"></input><br/>
<u>Kategoria:</u><br/>
<select name="kat2">
		<option></option>
		<option>wpłaty</option>
		<option>korespondencja</option>
		<option>informacje</option>
		<option>ludzie</option>
	</select>
	<br/>
<input type="submit" value="ZAMIEŃ"></input></span>
</form>	
<td/>
</tr>
</table>
