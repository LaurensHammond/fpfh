...
<div class="container">
	...
	<div id="main">
	<h1><center>Aktualności</center></h1>
<?php
	
if(isset($_SESSION['admin'])&&($_SESSION['admin']==true))
echo "<a href='aktualnosci_mod1.php'>[------- + DODAJ WPIS -------]</a><br/><br/><br/>";	
	...
	{
		$sql = "SELECT * FROM aktualnosci ORDER BY Data";
		if($rezultat = @$polaczenie->query($sql))
		{
			$ile_postow = $rezultat->num_rows;
			for($i=0;$i<$ile_postow;$i++)
			{	
				$sql2 = "SELECT * FROM aktualnosci ORDER BY Data DESC LIMIT 1 OFFSET $i";
					...
					if($foto!=NULL)
					{
						echo "<img src='aktualnosci_zdj/$foto' width='350px' align='right'/>";
					}
