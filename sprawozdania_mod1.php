...
<form action="sprawozdania_dodaj.php" method="post">
ROK:<br/>
<input type="text" name="rok" size="4"></input><br/>
Nazwa dokumentu pdf/docx:<br/>
<input type="text"name="link" size="70"></input><br/>
Treść sprawozdania (opcjonalnie): <br/>
<textarea cols="45" rows="4" name="opis"></textarea><br/>
