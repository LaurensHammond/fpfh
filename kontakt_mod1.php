...
<form action="kontakt_dodaj.php" method="post">
<input type="hidden" name="id" value="$id"/>
Nagłówek:<br/>
<input type="text" name="naglowek2" size="28"></input><br/>
Wartość:<br/>
<textarea cols="30" rows="4" name="dane2"></textarea><br/>
Waga:<br/>
...
<select name="kat2">
		...
		<option selected="selected">korespondencja</option>
		<option>informacje</option>
		<option>ludzie</option>
	</select>
	<br/>
<input type="submit" value="DODAJ"></input></span>
</form>	
	</div>
	<div style="clear:both;"></div>
</div>
