...
<form action="partnerzy_dodaj.php" method="post">
Nazwa:<br/>
<input type="text" name="nazwa" size="30"></input><br/>
Nazwa zdjęcia(z rozszeżeniem! np.: zdjecie.png):<br/>
<input type="text"name="photo" size="70"></input><br/>
<font color="#238E23" size="2">Zdjęcie musi zostać umieszczone w folderze: "partnerzy_zdj"</font><br/>
Opis:<br/>
<textarea cols="45" rows="4" name="opis">Opis...</textarea><br/>
